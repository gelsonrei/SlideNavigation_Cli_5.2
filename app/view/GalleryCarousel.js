Ext.define('SlideNavigation.view.GalleryCarousel', {
	...
	config : {
		fullscreen : true,
		modal : true,
		html : '<div class="close-gallery" style="padding-top: 50px;" data-action="close_carousel"></div>',
		...
		listeners : {
			...
			activeitemchange : function(carousel, newPanel){ this.changeImageCount(newPanel); }
		}
	},
	...
	changeImageCount : function(activePanel){
		var me = this;								
		me.bottomBar.setTitle(activePanel.config.index + ' de ' + me.totalCount);
	}
});
